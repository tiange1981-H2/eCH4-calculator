        ...
        <section className="main-content">
          <div className="metrics-grid">
            <div className="card metric-card lcoh">
              ...
              <div style={{ marginTop: '1.5rem', color: '#94a3b8', fontSize: '0.9rem', textAlign: 'left' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>年产氢量:</span> <span>{results.metrics.annualH2} 吨</span></div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>制氢总投资:</span> <span>{results.metrics.h2TotalCapex} 万元</span></div>
              </div>
            </div>
            <div className="card metric-card methane">
              ...
              <div style={{ marginTop: '1.5rem', color: '#94a3b8', fontSize: '0.9rem', textAlign: 'left' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>年产甲烷量:</span> <span>{results.metrics.annualMethane} 吨</span></div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>年产甲烷体积:</span> <span>{results.metrics.annualMethaneVol} 万方</span></div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>年产甲烷能量:</span> <span>{results.metrics.annualMethaneMWh} MWh</span></div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.5rem', borderTop: '1px solid #1e293b', paddingTop: '0.5rem' }}>
                  <span>等热值对应甲醇价格:</span> <span style={{ color: '#f59e0b' }}>{results.metrics.equivMethanolPrice} 元/吨</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.2rem' }}>
                  <span>全厂净效率:</span> <span style={{ color: '#3b82f6' }}>{results.metrics.netEfficiency}%</span>
                </div>
              </div>
            </div>
          </div>
...
function InputControl({ label, name, value, min, max, step, onChange, displayTransform }) {
  return (
